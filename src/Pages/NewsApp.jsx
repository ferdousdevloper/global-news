...
const socket = io('global-news-server-phi.vercel.app'); // Your server URL
...
const NewsApp = () => {
  ...
  const fetchAllNews = async () => {
    try {
      const response = await axios.get('global-news-server-phi.vercel.app/news'); // Your server URL
