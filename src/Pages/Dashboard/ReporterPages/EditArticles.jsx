...
const EditArticles = () => {
  ...
  useEffect(() => {
    const fetchArticle = async () => {
      ...
      try {
        const response = await axios.get(`global-news-server-phi.vercel.app/news/get-article/${articleId}`);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.patch(`global-news-server-phi.vercel.app/news/edit-article/${articleId}`, article);
