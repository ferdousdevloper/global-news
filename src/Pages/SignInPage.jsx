  ...
  const handleGoogleSignIn = () => {
    signInWithGoogle().then((result) => {
      ...
      Swal.fire({
        position: "top-center",
        icon: "success",
        title: "Welcome to the Global News Platform.",
      ...
      <div className="relative flex w-full max-w-4xl bg-white rounded-lg shadow-lg overflow-hidden z-10 border border-[#02AA08]">
        ...
        <div className="w-1/2 bg-gray-800 p-8 flex flex-col justify-center">
          ...
          <div className="flex justify-center space-x-4 text-gray-300">
            ...
            <button aria-label="Log in with Twitter" className="p-3 rounded-sm text-[#02AA08]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 32 32"
                className="w-5 h-5 fill-current"
            ...
            <button aria-label="Log in with GitHub" className="p-3 rounded-sm text-[#02AA08]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 32 32"
                className="w-5 h-5 fill-current"
