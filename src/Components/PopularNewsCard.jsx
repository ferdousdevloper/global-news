...
const PopularNewsCard = ({ news }) => {
    // console.log(news)
    const { _id, image, category, title, timestamp, description } = news
    ...
    return (
        ...
        <div className=" p-4 rounded-lg shadow-lg flex flex-col h-full min-h-[400px]">

            <div className="w-full p-1 rounded-lg shadow-lg  flex flex-col h-full min-h-[400px]">
                ...
                <div className="w-full flex-grow flex flex-col min-h-[250px]">
                    ...
                    <p className="text-sm mb-2 text-slate-100">{new Date(timestamp).toLocaleDateString()}</p>
                    <hr />
